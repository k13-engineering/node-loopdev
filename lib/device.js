...
const findOrAllocateDevicePath = async () => {
...
const findOrAllocate = async () => {
  const devicePath = await findOrAllocateDevicePath();
  const loopDeviceHandle = await fs.promises.open(devicePath, "r+");
